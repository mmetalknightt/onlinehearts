                        ...
                        <div className="london" style={{position: 'fixed'}}>
                            ...
                            <Typewriter
                                onInit={(typewriter) => {
                                    typewriter
                                    .changeDelay(10)
                                    .typeString("MMETALKNIGHTT’S 7 track debut album, <br>with features from kwes e + KAMAL, and <br>partial mastering from transpose <br>")
                                    .start();
                                }}
                            />
                            <a href='https://soundcloud.com/mmmiiikkkiii/sets/mkdriver' target='_blank' rel='noreferrer'>
                                + listen
                            </a>
                        </div>
                    </div>
